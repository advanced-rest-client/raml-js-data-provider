...
class RamlJsDataProvider {
  ...
  constructor(opts, logger) {
    ...
    this.opts = opts;
    this.logger = logger || this.__setupLogger();
   ...
   */
  __setupLogger() {
    let level = this.opts.verbose ? 'debug' : 'error';
  ...
  printValidationWarnings() {
    let warnings = this.opts.validationWarnings;
  ...
  observeApi() {
    ...
    let observablePath = this.opts.projectRoot + '/**/*.*';
